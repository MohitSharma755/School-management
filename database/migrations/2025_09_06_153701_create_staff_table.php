...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('staff', function (Blueprint $table) {
            ...
            $table->string('address'); // Column for the student's address, nullable
            // $table->string('class'); // Column for the course the student is registering for
            $table->string('phoneNumber'); // Column for the student's phone number, unique
            $table->string('emergencyContact'); // Column for the emergency contact, unique
            ...
            $table->string('profilePicture'); // Column for the student's profile picture, nullable
