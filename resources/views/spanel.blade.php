    ...
    <div class="d-flex">
        ...
        <aside id="sidebar" class="sidebar">
            <h5 class="text-center mb-4">
                <li class="list-group-item bg-official text-white">
                    <svg height="50" width="40" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#3F3F3F" />
                        <path d="m45.131 12.155l-9.31.91l-9.07-.88l-5.44-.53l13.88-2.53l15.13 2.53z" fill="#9B9B9A" />
                        <path
            ...
            <ul class="list-group list-group-flush">
               ...
               <a href="http://" target="_blank" rel="noopener noreferrer"> <li class="list-group-item">Student`s Application</li></a>
               <a href="http://" target="_blank" rel="noopener noreferrer"> <li class="list-group-item">Check your Attendence</li></a>
               <a href="http://" target="_blank" rel="noopener noreferrer"> <li class="list-group-item">Check your Class</li></a>
               <a href="http://" target="_blank" rel="noopener noreferrer"> <li class="list-group-item">Give Feedback</li></a>
               <a href="http://" target="_blank" rel="noopener noreferrer"> <li class="list-group-item">Pay Fee</li></a>
               <a href="http://" target="_blank" rel="noopener noreferrer"> <li class="list-group-item">Library </li></a>


                <a href="http://" target="_blank" rel="noopener noreferrer"> <li class="list-group-item"> <svg height="30" width="30" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        ...
        <main id="main-content" class="main-content flex-grow-1 p-4 p-md-5">
            <div class="bg-white container-fluid my-5 py-2 border border-success rounded-3 shadow-lg ">
                <p class="text-muted">Your Attendence</p>
                <h3 class="fw-bold color">75%</h3>
            </div>
            <div class="bg-white container-fluid my-5 py-2 border border-success rounded-3 shadow-md ">
                <p class="text-muted">Missed class</p>
                <h3 class="fw-bold text-danger">10</h3>
            </div>
            <div class="bg-white container-fluid my-5 py-2 border border-success rounded-3 shadow-lg ">
                <p class="text-muted">Due Fee</p>
            ...
            <div class="bg-white p-4 rounded-3 shadow-sm overflow-x-auto">
                <table class="table table-bordered  ">
                    <thead class="table-light">
                        <h1 class="color">Student Details</h1>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="color">John Doe</td>
                            <td class="color">john@example.com</td>
                            <td class="color">Computer Science</td>
                            <td class="color">6th sem/ 3rd Year</td>
