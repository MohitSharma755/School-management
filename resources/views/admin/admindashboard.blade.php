    ...
    <div class="d-flex">
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <img src="{{asset('images/staff.png')}}" alt="Manage Faculties" style="width: 40px; height: 40px; "> Manage Faculties
                </li>
                    ...
                    <tbody>
                        <tr>
                          ...
                          {{-- <tr>
                            ...
                            <td>Computer Science</td>
                            <td>
                                <img src="{{ asset('images/profile.jpg') }}" alt="Profile Pic" class="rounded-circle"
                                    style="width: 50px; height: 50px; object-fit: cover;">
                            </td>
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <button class="btn btn-info btn-sm rounded-pill text-white">Details</button>
